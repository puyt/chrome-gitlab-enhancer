...
- **highlight**: fix highlight MRs and issues in group overviews. [#56](https://github.com/puyt/ux-enhancer-for-gitlab/issues/56)
...
- **avatar**: fix issue where the same project logo is rendered on all items. [#54](https://github.com/puyt/ux-enhancer-for-gitlab/issues/54)
- **mr**: fix highlight my approvals in GitLab 19.2. [#56](https://github.com/puyt/ux-enhancer-for-gitlab/issues/56)
- **issues/mr**: fix highlight my issues and MRs in GitLab 19.2. [#56](https://github.com/puyt/ux-enhancer-for-gitlab/issues/56)
...
- **epic-board**: add assignee avatars to epic board by @pmezykowski in [#51](https://github.com/puyt/ux-enhancer-for-gitlab/pull/51).
